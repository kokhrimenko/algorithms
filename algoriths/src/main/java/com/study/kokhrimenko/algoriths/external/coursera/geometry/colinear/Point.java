...
public class Point implements Comparable<Point> {
    ...
    private static class PointSlopeComparator implements Comparator<Point> {
        ...
        public PointSlopeComparator(Point thisPoint) {
            this.thisPoint = thisPoint;
        }

        @Override
        public int compare(Point point1, Point point2) {
            double point1Slope = point1.slopeTo(thisPoint);
            double point2Slope = point2.slopeTo(thisPoint);
            if (Double.compare(point1Slope, point2Slope) == 0) {
                return 0;
            }
            return point1Slope > point2Slope ? 1 : -1;
        }
    }
